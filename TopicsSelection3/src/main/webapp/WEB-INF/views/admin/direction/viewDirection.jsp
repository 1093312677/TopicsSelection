...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<input type="text" name="qq1" placeholder="学生QQ（选填）" id="directionid" class="form-control"/>
				<label>方向：</label><input type="text" name="directionname1" placeholder="方向名称（*必填）" id="directionname1" class="form-control"/>
            	<br>
	...
	function editInfo(directionId) { 
		...
		$.ajax({
			...
			success:function(data){
				$("#directionname1").val(data.direction.directionName);
			},
			error:function(msg){
				console.log(msg)
			}
