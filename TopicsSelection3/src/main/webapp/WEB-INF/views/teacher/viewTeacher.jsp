	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
            	...
            	<br>
            	<label>工号：</label><input type="text" name="no1" placeholder="教师学号（*必填）" id="no1" class="form-control"/>
            	<br>
            	...
            	<br>
            	<label>系：</label><input type="text" name="department1" placeholder="教师备注（选填）" id="department1" class="form-control"/>
            	<br>
