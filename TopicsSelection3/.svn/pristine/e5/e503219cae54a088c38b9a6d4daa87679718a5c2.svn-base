	 ...
	 <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
			...
			<span class="icon-bar"></span>
                ...
                <a class="navbar-brand" href="#">毕业选题系统</a>
            </div>
            <!--
						...
						<li>
	                        ...
	                        <c:if test="${privilege == 2}"> 
		                        <ul id="topics" class="nav nav-list collapse secondmenu" style="height: 0px;">
		                            ...
		                            <li><a href="<%=request.getContextPath() %>/topic/goAddTopic.do" target="frame">　添加题目</a></li>
...
<!-- 
        ...
        -->          
            ...
            <div class="col-sm-10" id="right">
                ...
                <iframe src="<%=request.getContextPath() %>/account/mainpage.do" name="frame" width="100%" height="1080px" frameborder="0">
