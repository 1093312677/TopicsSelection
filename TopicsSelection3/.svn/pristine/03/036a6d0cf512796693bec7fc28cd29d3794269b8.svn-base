        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="grade-content">
            		<input type='text' class='form-control' id='grade' hidden='hidden' placeholder='年级' required/>
            	</div>
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<input type="text" name="qq1" placeholder="学生QQ（选填）" id="gradeid" class="form-control"/>
	...
	function editInfo(gradeId) { 
		...
		$.ajax({
			...
			success:function(data){
				$("#gradename1").val(data.grade.gradeName);
			},
			error:function(msg){
				console.log(msg)
			}
